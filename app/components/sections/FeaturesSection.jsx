    ...
    return (
        <section className="h-auto py-12 flex flex-col items-center bg-gray-100">
            ...
            <div className="text-center px-4 md:px-12 mb-12">
                <h1 className="text-3xl md:text-4xl font-semibold mb-4">UNLOCK YOUR TRUE SHOOTING POTENTIAL</h1>
            ...
            <div className="flex flex-wrap justify-center items-center gap-10 mb-12">
                <div className="p-2 bg-primary-gray rounded-lg hover:scale-105 transition duration-300">
            ...
            <div className="text-center px-4 md:px-12">
                <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                    <div className="md:w-1/3">
                        <h2 className="text-2xl font-semibold mb-2">Customized Training</h2>
                        <p>Our training plans are meticulously crafted to fit your unique skills and goals. From foundational drills to advanced techniques, our program adapts to your growth and challenges you at every step.</p>
                    </div>
                    <div className="md:w-1/3">
                        <h2 className="text-2xl font-semibold mb-2">Community Support</h2>
                        <p>Join a vibrant community of enthusiastic players and mentors. Share your experiences, learn from peers, and get inspired by the collective passion for basketball. Our platform is a hub for engagement and support.</p>
                    </div>
                    <div className="md:w-1/3">
                        <h2 className="text-2xl font-semibold mb-2">Progress Tracking</h2>
                        <p>Track your development with our state-of-the-art tools. Watch as your precision and consistency improve over time, with measurable results that reflect your hard work and dedication to the sport.</p>
                    </div>
                </div>
            </div>
        </section>
