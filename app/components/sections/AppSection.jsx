    ...
    return (
        <section className="bg-white py-12 px-4">
            <div className="max-w-6xl mx-auto">
                <h2 className="text-4xl font-bold text-center text-primary-gray mb-6">
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-8">
                    <div className=" flex gap-4 flex-wrap justify-center">
                        <Image src={AppFeature1} alt="Feature 1" className="rounded-md shadow-md transition duration-300 ease-in-out hover:scale-105" width={250} height={200} />
                        <Image src={AppFeature2} alt="Feature 2" className="rounded-md shadow-md transition duration-300 ease-in-out hover:scale-105" width={250} height={200} />
                    </div>
                    <div className="flex gap-4 flex-wrap justify-center" >
                        <Image src={AppFeature3} alt="Feature 3" className="rounded-md shadow-md transition duration-300 ease-in-out hover:scale-105" width={250} height={200} />
                        <Image src={AppFeature4} alt="Feature 4" className="rounded-md shadow-md transition duration-300 ease-in-out hover:scale-105" width={250} height={200} />
                    </div>
                </div>
